package com.melly.timerocketserver.domain.chest.controller;

import com.melly.timerocketserver.domain.chest.dto.response.ReceivedChestDetailResponse;
import com.melly.timerocketserver.domain.chest.dto.response.ReceivedChestPageResponse;
import com.melly.timerocketserver.domain.chest.service.ReceivedChestService;
...
public class ReceivedChestController implements ResponseController {
    private final ReceivedChestService receivedChestService;
    public ReceivedChestController(ReceivedChestService receivedChestService){
